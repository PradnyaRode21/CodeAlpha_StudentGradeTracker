...
✔️ Add student records ✔️ Store student names and grades ✔️ Calculate average score ✔️ Find highest score ✔️ Find lowest score ✔️ Display summary report of all students ✔️ Menu-driven command-line interface (CLI)
...
StudentGradeTracker.java Student.java (optional) README.md

📊 Functionalities

1️⃣ Add Student Enter Student Name Enter Student Grade/Score Store records using ArrayList
